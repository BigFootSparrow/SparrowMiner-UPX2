		...
		uint32_t startNonce, uint32_t * __restrict__ d_input )
{
	...
	if(ALGO == cryptonight_monero_v8 || ALGO == cryptonight_v8_reversewaltz || ALGO == cryptonight_turtle)
	{
	...
	for(int i = start; i < end; ++i)
	{
		...
		else if(ALGO == cryptonight_v8_reversewaltz || ALGO == cryptonight_turtle) 
		{
		...
		if((ALGO == cryptonight_monero_v8 || ALGO == cryptonight_v8_reversewaltz || ALGO == cryptonight_turtle) && sub == 1)
		{
...

		{
			...
			if(ALGO == cryptonight_v8_reversewaltz || ALGO == cryptonight_turtle)
			{
