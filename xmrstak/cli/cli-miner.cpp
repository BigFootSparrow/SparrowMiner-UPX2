...
int main(int argc, char *argv[])
{
	...
	printer::inst()->print_str("\n\n");
	printer::inst()->print_str("Brought to you by BigFoot Sparrow under GPLv3.\n");
	...
	printer::inst()->print_str("-------------------------------------------------------------------\n");
	printer::inst()->print_str("                     `.              .`                     \n");
	printer::inst()->print_str("                 `:ohdd:     ``     :ddho:`                 \n");
	printer::inst()->print_str("               -sddddddh.:shddddhs:.hdddddds-               \n");
	printer::inst()->print_str("             -ydddddddddh+hddddddh+hdddddddddy:             \n");
	printer::inst()->print_str("           -o-sdddddddddddooddddoodddddddddddddy:           \n");
	printer::inst()->print_str("         -ysydsydddddddddddh+oo+hddddddddddddddddy-         \n");
	printer::inst()->print_str("       `oddddddddddddddddddddhhddddddddddddddddddddo`       \n");
	printer::inst()->print_str("      :hddddddddddddddddddddddddddddddddddddddddddy/:-      \n");
	printer::inst()->print_str("    `oddddddddddddddddddddddddddddddddddddddddddhssdddo`    \n");
	printer::inst()->print_str("   .yddddddddddddddddddddddddddddddddddddddddddddddddddy.   \n");
	printer::inst()->print_str("   /yddddddddddddddddddddddddddddddddddddddddddddddddddy/   \n");
	printer::inst()->print_str("     -+ydddddddddddddddy+o+:````..-:/oydddddddddddddy+-     \n");
	printer::inst()->print_str("        `-/oyhdddyso++++++//:`      ./o+-+ydddhyo/-`        \n");
	printer::inst()->print_str("               `hy/.``.:////+/. `:+o/.     y`               \n");
	printer::inst()->print_str("              .hd.   -yddhs::+++/::+y/`    hh`              \n");
	printer::inst()->print_str("               hd:   odddddd:` -yhddds+-  `dy               \n");
	printer::inst()->print_str("               :dd+/+oohddy/   .o`...   .:yd:               \n");
	printer::inst()->print_str("                yddyo:.`            `-:oyddy                \n");
	printer::inst()->print_str("                /ydho/-`   -/++/.   `-/shhy:                \n");
	printer::inst()->print_str("                  +h+:` `/oyddddyo:` .:+h/                  \n");
	printer::inst()->print_str("                  .dh/ .hddo:--:oddh.`/hd.                  \n");
	printer::inst()->print_str("                  `dddhhddy/osso/yddhhddd                   \n");
	printer::inst()->print_str("                   yhhddddddddddddddddhhy                   \n");
	printer::inst()->print_str("                   -`sddddddddddddddddo`-                   \n");
	printer::inst()->print_str("                     +doddddddddddddsd/                     \n");
	printer::inst()->print_str("                     -- ydddddddddds --                     \n");
	printer::inst()->print_str("                        +dhdddddhhd/                        \n");
	printer::inst()->print_str("                        -+`:dddd:`+.                        \n");
	printer::inst()->print_str("                            /dd/                            \n");
	printer::inst()->print_str("                             o+                             \n");
	printer::inst()->print_str("                                                            \n");
	printer::inst()->print_str("-------------------------------------------------------------------\n");
