...
xmrstak::coin_selection coins[] = {
	...
	{ "cryptonight_upx2",        {POW(cryptonight_turtle)},    {POW(cryptonight_v8_reversewaltz)},    nullptr },
	...
	{ "turtlecoin",              {POW(cryptonight_turtle), 6u,POW(cryptonight_v8_reversewaltz)}, {POW(cryptonight_v8_reversewaltz)}, nullptr },
...
{
	const char* default_example = "dtnweb.hopto.org:3335";
